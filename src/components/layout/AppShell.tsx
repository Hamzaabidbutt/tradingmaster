...
const NAV = [
  ...
  { href: "/bos", label: "BOS Momentum", icon: "⚡" },
  { href: "/flow", label: "Flow Alignment", icon: "🧭" },
  { href: "/ladder", label: "Trendline Ladders", icon: "📐" },
  { href: "/rsi-divergence", label: "RSI Divergence", icon: "📉" },
  { href: "/cvd-divergence", label: "CVD Divergence", icon: "🌊" },
  { href: "/thrust", label: "Retest & Thrust", icon: "🎯" },
  { href: "/ledger", label: "Scorecard", icon: "📒" },
